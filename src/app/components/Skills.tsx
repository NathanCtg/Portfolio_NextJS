    ...
    return (
        <div className="container" id="Compétences">
            <div className="skills-container p-12 flex flex-col text-left bg-gray-900 w-full mx-auto">
                ...
                <div className="skills-grid"> {/* Garder la classe CSS pour le style de la grille */}
                    <div className="skill"> {/* Garder la classe CSS pour le style de la carte */}
                        ...
                        <div className="skill-content">
                            ...
                            <div className="flex-chips"> {/* Garder la classe CSS pour les chips */}
                                <span className="chip-title">Tech stack:</span>
                                {skills.technical.map((label, index) => (
                                    <span key={index} className="chip">{label}</span> // Garder la classe CSS pour les chips
                                ))}
                            </div>
                        </div>
                    </div>
